          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="https://line.me/R/ti/p/@p.s.mediasupply" target="_blank" rel="noopener noreferrer" className="text-neutral-400 text-sm hover:text-[#06C755] transition-colors">
                  LINE Official
                </a>
              </li>
              <li className="flex items-start gap-3">
