...
export const metadata: Metadata = {
  ...
  description:
    "โรงพิมพ์ P.S. MEDIAS SUPPLY นนทบุรี ใกล้กรุงเทพ บริการงานพิมพ์ครบวงจร คอมพิวเตอร์ฟอร์ม ออฟเซ็ท สติ๊กเกอร์ แบบฟอร์มธุรกิจ ประสบการณ์ 20+ ปี โทร 081-922-6779",
  ...
  openGraph: {
    ...
    description: "โรงพิมพ์บริการพิมพ์ครบวงจร นนทบุรี ใกล้กรุงเทพ ประสบการณ์ 20+ ปี โทร 081-922-6779",
    type: "website",
    locale: "th_TH",
...
export default function PrintingCompanyBangkokPage() {
  return (
    <LandingPage
      ...
      subheadline="โรงพิมพ์คุณภาพในนนทบุรี ใกล้กรุงเทพ ให้บริการงานพิมพ์ครบวงจรมากว่า 20 ปี คอมพิวเตอร์ฟอร์ม งานพิมพ์ออฟเซ็ท สติ๊กเกอร์ทุกชนิด แบบฟอร์มธุรกิจ กล่องบรรจุภัณฑ์ ฉลากสินค้า"
      keyword="โรงพิมพ์"
      description="P.S. MEDIAS SUPPLY CO., LTD. คือโรงพิมพ์ที่ให้บริการงานพิมพ์ครบวงจรมากว่า 20 ปี ตั้งอยู่ในนนทบุรี ใกล้กรุงเทพ เราให้บริการพิมพ์เอกสารธุรกิจ คอมพิวเตอร์ฟอร์ม กระดาษต่อเนื่อง สติ๊กเกอร์ ฉลากสินค้า กล่องบรรจุภัณฑ์ และงานพิมพ์ออฟเซ็ททุกชนิด ด้วยงานดีมีคุณภาพ ซื่อสัตย์ ตรงต่อเวลา ราคายุติธรรม"
      products={[
      ...
      benefits={[
        { title: "ประสบการณ์ 20+ ปี", description: "ดำเนินธุรกิจมากว่า 20 ปี ส่งมอบงานให้ลูกค้ามากกว่า 1,000 ราย" },
